...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Movie">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'hint_code', name: 'hint_code' },
{ data: 'thumnail', name: 'thumnail', sortable: false, searchable: false },
{ data: 'images', name: 'images', sortable: false, searchable: false },
{ data: 'genres', name: 'genres.title' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Movie').DataTable(dtOverrideGlobals);
