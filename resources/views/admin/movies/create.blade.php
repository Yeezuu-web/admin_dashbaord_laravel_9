    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.movies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hint_code') ? 'is-invalid' : '' }}" type="text" name="hint_code" id="hint_code" value="{{ old('hint_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('synopsis') ? 'is-invalid' : '' }}" name="synopsis" id="synopsis">{!! old('synopsis') !!}</textarea>
